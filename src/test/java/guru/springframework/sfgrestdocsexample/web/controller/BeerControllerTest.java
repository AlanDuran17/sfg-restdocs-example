...
//Linea comentada debido a que este import genra conflictos con los RestDocs, en su lugar se usa el de abajo
        ...
        mockMvc.perform(get("/api/v1/beer/{beerId}", UUID.randomUUID().toString())
            ...
            .andDo(document("v1/beer-get",
                ...
                responseFields(
                    ...
                    fieldWithPath("price").description("Description"),
        ...
        mockMvc.perform(post("/api/v1/beer/")
                ...
                .andDo(document("v1/beer-save",
                        requestFields(
                                ...
                                fields.withPath("price").description("Description"),
